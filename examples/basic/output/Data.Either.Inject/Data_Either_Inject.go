...
func ꞋinjectLeft() Any {
    ᛌinjectLeft_once.Do(func() {
        ᛧinjectLeft = Dict{"inj": Data_Either.ꞋLeft(), "prj": Apply(Data_Either.Ꞌeither(), Data_Maybe.ꞋJust(), Apply(Data_Function.Ꞌconst(), Data_Maybe.ꞋNothing())),}
    })
return ᛧinjectLeft
}
...
func ꞋinjectRight() Any {
    return func(dictInject Any) Any {
        return Dict{"inj": Apply(Ꞌcompose(), Data_Either.ꞋRight(), Apply(Ꞌinj(), dictInject)), "prj": Apply(Data_Either.Ꞌeither(), Apply(Data_Function.Ꞌconst(), Data_Maybe.ꞋNothing()), Apply(Ꞌprj(), dictInject)),}
    }
}
